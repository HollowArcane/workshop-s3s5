...
public class TicketDTO {
	...
	public static List<VLabelTicketDTO> fetchByComponentCategory(DSLContext context, Integer idComponentCategory) {
		var result = context.select(
				...
				DSL.listAgg(Tables.V_LABEL_COMPONENT.COMPONENT_CATEGORY, ", ")
						.withinGroupOrderBy(Tables.V_LABEL_COMPONENT.COMPONENT_CATEGORY))
				...
				.leftJoin(Tables.V_LABEL_COMPONENT)
	...
	public static List<VLabelTicketDTO> fetchByIdModelCategoryAndReparationDetail(DSLContext context,
			Integer idModelCategory, Integer idComponentCategory) {
		var result = context.select(
				Tables.V_LABEL_TICKET,
				DSL.listAgg(Tables.V_LABEL_COMPONENT.COMPONENT_CATEGORY, ", ")
						.withinGroupOrderBy(Tables.V_LABEL_COMPONENT.COMPONENT_CATEGORY))
