...
public class MvtTicketStateController
{
    public static void page(Context context)
    {
        Renderer.usingDefault()
            ...
            .with(context, Map.of("active", "/ticket/mvt-ticket-state"));
    }
        ...
        SQLException
    {
        ...
        List<MvtTicketStateDTO> data = DB.handle(ctx -> {
            return ctx.fetch(MVT_TICKET_STATE).map(MvtTicketStateDTO::new);
        });
